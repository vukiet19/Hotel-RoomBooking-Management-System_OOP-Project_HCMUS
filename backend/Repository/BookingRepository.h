// File BookingRepos ~ trạm trung chuyển: kết nối giữa database và back-end: đọc
// dữ liệu Booking từ file Booking lên database
...
public:
  ...
  bool updateBooking(int bookingId, int customerId, const QString &roomNumber,
                     ...
                     double totalPrice, const QString &statusStr);
  ...
  // mình sẽ load lại UI dựa vào vector<Booking*> mới được trả về này(getAll và
  // filter) Trả về tất cả booking, caller quản lý bộ nhớ
