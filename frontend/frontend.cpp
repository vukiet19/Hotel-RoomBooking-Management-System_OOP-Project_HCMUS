...
MainWindow::MainWindow(QWidget *parent) : QWidget(parent)
{
    ...
    QList<QPushButton *> buttons = {button1, button2, button3, button4, button5,
                                    button6, button7, button8, button9, button10, buttonDashboard};
    ...
    connect(buttonDashboard, &QPushButton::clicked, this, &MainWindow::handleDashboardTab);
}
...
void MainWindow::handleDashboardTab()
{
    ...
    connect(btnFilter, &QPushButton::clicked, this, &MainWindow::showFilterDashboardDialog);
...
void MainWindow::showFilterDashboardDialog()
{
